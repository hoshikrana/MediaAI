    ...
    def generate(session_data: dict, output_path: Path) -> Path:
        ...
        styles.add(
            ParagraphStyle(
                ...
                textColor=TEAL, fontSize=16, spaceAfter=12
            )
        )
        styles.add(
            ParagraphStyle(
        ...
        t_risk = Table(
            risk_data, colWidths=[4 * inch], rowHeights=[0.8 * inch]
        )
        ...
        # Disclaimer
        disclaimer_txt = (
            "<b>⚠️ EDUCATIONAL PURPOSES ONLY</b><br/>"
            "This report is generated by an AI system. It is NOT a clinical "
        ...
        story.append(
            Paragraph("Imaging Findings", styles['SectionHeader'])
        )
        ...
        if vision and vision.get("heatmap_base64"):
            try:
                # Assuming base64 is properly formatted
        ...
        story.append(
            Paragraph("Clinical Analysis", styles['SectionHeader'])
        )
        ...
        # --- PAGE 4: NARRATIVE ---
        story.append(
            Paragraph("AI Narrative Report", styles['SectionHeader'])
        )
        report_text = result_json.get(
            "report_text", "No narrative generated."
        )
